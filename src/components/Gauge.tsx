  ...
  return (
    <div className={cn('mx-auto w-full max-w-80', className)}>
      <svg viewBox="0 0 200 150" className="block w-full overflow-visible">
        <path d={arcPath(TRACK_R, 180, 120)} className="fill-none stroke-tertiary/55" strokeWidth={14} strokeLinecap="round" />
        <path d={arcPath(TRACK_R, 120, 60)} className="fill-none stroke-primary/70" strokeWidth={14} strokeLinecap="round" />
        <path d={arcPath(TRACK_R, 60, 0)} className="fill-none stroke-secondary/75" strokeWidth={14} strokeLinecap="round" />

        <text x={14} y={115} textAnchor="middle" className="fill-on-surface-variant font-mono text-[9px]">
          {min}
        </text>
        <text x={100} y={14} textAnchor="middle" className="fill-on-surface-variant font-mono text-[9px]">
          {midLabel}
        </text>
        <text x={186} y={115} textAnchor="middle" className="fill-on-surface-variant font-mono text-[9px]">
          {max}
        </text>
        ...
        />
        <circle cx={CENTER_X} cy={CENTER_Y} r={9} className="fill-surface-container-high stroke-ghost-strong" strokeWidth={1} />
        ...
        <text x={100} y={138} textAnchor="middle" className="fill-on-surface-variant font-hebrew text-xs font-medium">
          {unit}
        </text>
      </svg>
    </div>
